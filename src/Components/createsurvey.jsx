...
export default function Createsurvey() {
  return (
    ...
    <Box textAlign={"center"}>
        <h6 fontSize="14px" color='gray'>Create a survey</h6>
        <Heading fontSize={"20px"}>How would you like to get started?</Heading>
    </Box>
   <div className={styles.Card_head}>
    ...
    <div>
           ...
           <Text style={{textAlign:'center',fontSize:"16px"}}>Start your survey from scratch</Text>
           <p style={{textAlign:"center",fontSize:"12px", marginTop:"10px"}}>Build your survey from scratch.</p>
